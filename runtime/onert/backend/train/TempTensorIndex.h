...
#ifndef __ONERT_BACKEND_TRAIN_TEMP_TENSOR_INDEX_H__
#define __ONERT_BACKEND_TRAIN_TEMP_TENSOR_INDEX_H__
...
/**
 * @brief Class that is index of TempTensor
 */
class TempTensorIndex
{
public:
  /**
   * @brief Construct TempTensorIndex object.
   * @param op_index      The operation index
   * @param operand_index The operand index
   */
  TempTensorIndex(const ir::OperationIndex &op_index, const ir::OperandIndex &operand_index)
...
public:
   ...
   *
   * @return Whether two TempTensorIndex are the same
   */
  bool operator==(const TempTensorIndex &other) const
  {
   ...
   * @brief operator overloading function for `!=`
   *
   * @return Whether two TempTensorIndex are differenct
   */
  bool operator!=(const TempTensorIndex &other) const { return !(*this == other); }
...
/**
 * @brief Structure that provides hash value of TempTensorIndex
 */
template <> struct hash<onert::backend::train::TempTensorIndex>
{
  size_t operator()(const onert::backend::train::TempTensorIndex &index) const noexcept
  {
...
#endif // __ONERT_BACKEND_TRAIN_TEMP_TENSOR_INDEX_H__
